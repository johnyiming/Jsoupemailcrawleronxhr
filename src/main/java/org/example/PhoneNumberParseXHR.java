...
public class PhoneNumberParseXHR {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = x; i < y; i++) {
                ...
                BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\User\\Documents\\javaproject\\Jsoupemailcrawleronxhr\\outputphoneurls.txt",true));
                bw.write("第: " + i + "页搜索结果\n");
                bw.close();
                ...
                for (Element link : links) {
                    ...
                    //Save to File output.txt
                    BufferedWriter bw2 = new BufferedWriter(new FileWriter("C:\\Users\\User\\Documents\\javaproject\\Jsoupemailcrawleronxhr\\outputphoneurls.txt",true));
                    bw2.write("\nhttps://xihua.es/"+linkresult+"\n");
                    bw2.close();

                    //Trim Email From linkresult
                    String s = new Scanner(new URL("https://xihua.es/"+linkresult).openStream(), "UTF-8").useDelimiter("\\A").next();
                    Matcher m = Pattern.compile("\\d{9,}", Pattern.CASE_INSENSITIVE).matcher(s);
                    ...
                    while (m.find()) {
                        ...
                        BufferedWriter bw3 = new BufferedWriter(new FileWriter("C:\\Users\\User\\Documents\\javaproject\\Jsoupemailcrawleronxhr\\outputphonelist.txt",true));
